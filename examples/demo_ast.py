"""Demo: plain-Python bot compiled via AST -> description -> graphc-rs.

Run: python examples/demo_ast.py
Output: examples/graphc_demo_soccer.txt (game save, replayed by the sim CI)
"""
